  ...
  return (
    <div className="container-sm p-5">
      <div className="row ps-3 pe-3 ms-3 me-3">
        <h1 className="fs-3 text-muted mt-4 mt-4">Charges explained</h1>
        <div className="col-6">
          <div>
            <h2>Securities/Commodities transaction tax</h2>
            <p>
              Tax by the government when transacting on the exchanges. Charged
              as above on both buy <br /> and sell sides when trading equity
          ...
          <div>
            ...
            <p>
              ...
              W, T) at ₹375 per crore of turnover on flat rate <br /> basis
          ...
          <div>
            ...
            <ul className="disc">
              <li>
                ...
                The interest is applied <br /> from T+1 day until the day MTF
                stocks are sold.
              </li>
              <li>
        ...
        <div className="col-6">
          ...
          <div>
            ...
            <p>
              ...
              charged on the trading account <br /> ledger when stocks are sold,
